...
// Source: github.com/kazemisoroush/assistant/pkg/records/knowledgebase (interfaces: Embedder)
//
// Generated by this command:
//
//	mockgen -destination=./mocks/mock_embedder.go -mock_names=Embedder=MockEmbedder -package=mocks . Embedder
//
